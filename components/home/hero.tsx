...
export function Hero() {
    return (
        <section className="relative lg:h-screen min-h-screen lg:min-h-[800px] h-auto flex items-start lg:items-center justify-center overflow-hidden bg-expert-navy text-white pb-24 lg:pb-0">
            {/* Abstract Background */}
